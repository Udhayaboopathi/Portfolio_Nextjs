...
export default function Contact({ aboutSection, projectsSection, skillsSection }) {
  ...
  return (
    <>
  <section id="contact" className="container mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-[65px]">
          <motion.div
              initial={{ opacity: 0, y: 50 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl pb-14 lg:pb-16"
